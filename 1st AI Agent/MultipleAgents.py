...
travel_agent = Agent(
    ...
    instructions=(
        ...
        "\n"
        "When planning a trip, call the **Planner Agent** to create daily schedules, organize destinations, and recommend attractions or activities. Do not create itineraries yourself.\n"
...
async def main():
    try:
        result = await Runner.run(travel_agent, '''I'm considering a trip to Dubai sometime in feb 2026 
                                                 around a week-long trip.     
                                                I'd like to get an idea of flight ticket prices, I will fly from cairo and some well-located hotels.     
                                                I'm also like Arabic food, so any recommendations for great local restaurants would be fantastic! 
